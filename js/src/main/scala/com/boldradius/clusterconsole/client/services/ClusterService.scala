...
import autowire._
import com.boldradius.clusterconsole.client.domain.{ NodeLike, ClusterGraphNode }
import com.boldradius.clusterconsole.client.modules.Mode
...
trait ClusterService extends Actor {
  ...
  import com.boldradius.clusterconsole.client.domain.NodeLike._
