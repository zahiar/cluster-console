...
import com.boldradius.clusterconsole.client.ClusterConsoleApp.{ ClusterMapLoc, DashboardLoc, Loc }
import com.boldradius.clusterconsole.client.style.Icon.Icon
