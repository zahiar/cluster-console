...
import com.boldradius.clusterconsole.client.modules.{ Mode, RxObserver }
import com.boldradius.clusterconsole.client.services.{ ClusterService, ClusterService$ }
import com.boldradius.clusterconsole.http.DiscoveredCluster
